...
function CreateTemplateModal({
  ...
  async function submit(e: React.SyntheticEvent) {
    ...
    setBusy(true);
    try {
      await apiClient('/contract-templates', {
        method: 'POST',
        body: { name: name.trim(), body: body.trim() },
      });
      setName('');
      setBody('');
      onCreated();
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button variant="primary" type="submit" form="create-template-form" loading={busy}>
            Criar
          </Button>
        </>
      }
    >
      ...
      >
        <Input
          ...
          placeholder="Ex.: Locação residencial padrão"
        />
        <Textarea
