...
const PATHS: Record<IconName, ReactNode> = {
  ...
  refresh: (
    <>
      <path d="M3 12a9 9 0 0 1 9-9 9.8 9.8 0 0 1 6.7 2.6L21 8" />
      <path d="M21 3v5h-5" />
      <path d="M21 12a9 9 0 0 1-9 9 9.8 9.8 0 0 1-6.7-2.6L3 16" />
      <path d="M3 21v-5h5" />
    </>
  ),
  calendar: (
  ...
  calendarClock: (
    <>
      ...
      <path d="M8 2v4" />
      <path d="M3 10h5" />
      <path d="M17.8 11.2a2 2 0 1 0 2.8 2.8" />
      <path d="M18 22a4 4 0 0 0 4-4c0-1.1-.45-2.1-1.17-2.83L18 18.7V22z" />
    </>
  ),
  timer: (
    <>
  ...
  globe: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M3 12h18" />
      <path d="M12 3a13.4 13.4 0 0 1 0 18 13.4 13.4 0 0 1 0-18" />
    </>
  ),
  whatsapp: (
    <>
      <path d="M3 21l1.65-4.98A8.5 8.5 0 1 1 7.5 19.3L3 21Z" />
      <path d="M8.5 8.5c0 3 2 6 5 6l1.5-1.5c.3-.3.3-.8 0-1.1l-1.3-.8a.8.8 0 0 0-1.1.3c-.6.8-1.5-.1-.7-.7a.8.8 0 0 1 .3-1.1l-.8-1.3a.8.8 0 0 0-1.1 0L8.5 8.5Z" />
    </>
  ),
  instagram: (
    <>
  ...
  barChart: (
    <>
      <path d="M3 3v18h18" />
      <rect width="4" height="10" x="7" y="9" rx="1" />
      <rect width="4" height="6" x="13" y="13" rx="1" />
      <rect width="4" height="14" x="17" y="5" rx="1" />
    </>
  ),
  pieChart: (
    <>
